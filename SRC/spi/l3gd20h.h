/********************************************************************************
  ...
  * @version V1.0.0
  * @date    22-12-2015
  * @brief   Header for l3gd20h.c module
*******************************************************************************/ 
#ifndef _L3GD20H_H_
#define _L3GD20H_H_
#include "stm32f4xx.h"
...
#define L3GD20_LOW_ODR_ADDR     			0x39  /* LOW_ODR register */
/******************************* END REGISTER MAPPING  ******************************/
/************************************************************************************/
/***************************** START SPI Interface pins  ****************************/

#define L3GD20_CS_PIN                      GPIO_PIN_13
#define L3GD20_CS_PORT                     GPIOC
#define L3GD20_CS_CLK_ENABLE()             __GPIOC_CLK_ENABLE()

#define L3GD20_ACC_DRDY_PIN                GPIO_PIN_0
#define L3GD20_ACC_DRDY_PORT               GPIOB
#define L3GD20_ACC_DRDY_CLK_ENABLE()       __GPIOB_CLK_ENABLE()

/****************************** END SPI Interface pins  *****************************/

/************************************************************************************/
/************************** START l3gd20h Selection define  *************************/
//Read/Write command
...
#define WHO_I_AM													 ((uint8_t)0xD4)						
#define WHO_I_AM_L3G4200D		    					 ((uint8_t)0xD3)								/* for L3G4200D */
